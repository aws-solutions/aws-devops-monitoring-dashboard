...
export class PipelineAlarmConstruct extends cdk.Construct {

    constructor(scope: cdk.Construct, id: string, props: PipelineMetricProps) {
        super(scope, id);
        ...
        const pipelineIlogGroup: logs.ILogGroup = logs.LogGroup.fromLogGroupName(this, "PipelineILogGroup", props.logGroupName);
        ...
        let metricFilter = new logs.MetricFilter(this, "FailedPipelineExecutionMetricFilter", {
            filterPattern: {
