...
import { ResourcePart, SynthUtils, expect as expectCDK } from '@aws-cdk/assert';
import '@aws-cdk/assert/jest';
import * as lambda from '@aws-cdk/aws-lambda';
import * as cdk from '@aws-cdk/core';
import {Role, ServicePrincipal, PolicyStatement, Effect, PolicyDocument, CfnRole} from '@aws-cdk/aws-iam';
import { ApplyCfnSuppressRulesToLogRententionResourc } from "../lib/util/apply_to_construct";
...
test('adding cfn suppressing rules to lambda', () => {
    ...
    const cwLogsPS = new PolicyStatement({
        ...
        effect: Effect.ALLOW,
        resources: [stack.formatArn({ service: 'logs', resource: 'log-group', arnFormat: cdk.ArnFormat.COLON_RESOURCE_NAME, resourceName: '/aws/lambda/*' })],
        sid: 'CreateCWLogs'
      })
    ...
    ApplyCfnSuppressRulesToLogRententionResourc(stack, 'testFunction')
